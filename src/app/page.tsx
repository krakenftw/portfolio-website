    ...
    <div className='min-h-screen text-primary w-screen flex items-center py-[50px] md:py-[150px] gap-10 flex-col'>
      ...
      <div className='w-4/5 md:w-3/5 lg:w-2/5 flex flex-col  gap-5 justify-center'>
          ...
          <div className='w-full'>
            <div className=' flex flex-col items-center md:items-start gap-4'>
              ...
              <div className='m-0 text-md z-10 text-gray-400'>
                🚀 Full stack developer exploring open source, always
                looking for new challenges and building innovative
                projects from the ground up. Passionate about creating
                clean, efficient code that makes a difference. When
                i&apos;m not coding, you&apos;ll find me deep into a
                chess match, strategizing my next move.
              </div>
            </div>
          </div>
        </AnimateOnLoad>
        ...
        <div className='text-primary'>
          ...
          <a
            className='underline'
            href='mailto:gauraverma4114@gmail.com'
          >
